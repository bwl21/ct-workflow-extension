 ...
 */
export async function getCustomDataCategories<T>(
  moduleId?: number,
  ...
  return categories.map((category) => {
    ...
    parsedData = safeParseJSON<T>(data, {} as T);
    return {
      ...rest,
      ...parsedData,
    };
 ...
 */
export async function getCustomDataCategory<T>(
  shorty: string,
 ...
 */
export async function getCustomDataValues<T>(
  dataCategoryId: number,
  moduleId?: number,
  ...
  return values.map((val) => {
    ...
    let parsedData = safeParseJSON<T>(value, {} as T);
    return {
      ...rest,
      ...parsedData,
    };
